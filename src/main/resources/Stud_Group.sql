...
('It-4',2,'2013-09-15',2,'created', now()),
('It-2',3,'2013-09-15',1,'created', now()),
('It-3',4,'2014-09-15',1,'created', now());
...
(3,10355,'Ivanov','Ivan','Ivanich','Vitebsk','Moskow awe., 73, 2, 9','+375297451471','expelled', now()),
...
(3,10362,'Ivanov','Ivan','Ivanich','Vitebsk','Pravdy st., 12, 1','+375297451199','expelled', now());
UNLOCK TABLES;
